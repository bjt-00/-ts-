<div id="<?php print('_'.$verseNo); ?>"  class="row <?php echo((($verseNo%2)==0?'OddRow':'EvenRow'));?>"   >
	...
	<a id='<?php print('verseNo'.$verse->AYAAT_ID); ?>' href="javascript:markForFutureReading('<?php print('verseRowNo'.$verseNo); ?>',<?php print($verse->AYAAT_ID); ?>,'<?php echo $userSetting->getVerseColor();?>')" title="Bookmark" class="glyphicon glyphicon-star-empty" style="color:<?php echo ($isBookmark?'green':'#e1e1e1');?>">
    </a>			
