...
<div class="row PageTitle" align='center' style='color:<?php echo $userSetting->getverseColor()?>' >
    <div class="col-lg-12 Heading <?php echo $userSetting->getArabicFont(); ?>" style="color:<?php echo $userSetting->getVerseColor(); ?>"  id="verseRowNo00">
     <?php if($userSetting->getQuranScript()=="quran_in_roman_script"){
		    	echo "A'udhu Billahi Minash Shaytanir Rajim";
		    }else{echo "أعوذ بالله من الشيطان الرجيم";  }
		    ?>
...
<div class="row PageTitle" align='center' style='color:<?php echo $userSetting->getverseColor()?>' >
    <div class="col-lg-12 <?php echo $userSetting->getTranslationFont(); ?>" style="color:<?php echo $userSetting->getTranslationColor(); ?>" id="verseRowNo00_1">
