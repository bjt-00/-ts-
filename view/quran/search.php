<form name='searchForm'  method='GET' >
	<input type="hidden" name="action" value="quran">
		...
		<input name='searchText' id="searchText" onkeypress="languageTranslator()" type='text' value="<?php echo (isset($_GET['searchText']) ?$_GET['searchText']:'');?>" placeholder="Type or Drag and drop Text here"  class="form-control">
