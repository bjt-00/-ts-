...
function isEmpty(i) {
    ...
    if (Boolean(i) && false != i) {
        for (var I in i)
            if (i.hasOwnProperty(I)) return false
    }
    return true
}
    ...
    var _ = function (i, c) {
        ...
        C.add = function () {
            if (!C.exists()) {
                ...
                Q.type = 'text/css';
                Q.href = i;
                //O.appendChild(Q); //gate2home - manually add css layout
            }
        };
        C.exists = function () {
...
DocumentCookie = new function () {
    ...
    o.set = function (i, I, Q, _, c, C) {
        if (i) {
            I = escape(I);
            document.cookie = i + "=" + I + (_ ? ";path=" + _ : "") + (Q ? ";NoExp=" + ((Q instanceof Date) ? Q.toGMTString() : new Date(new Date().getTime() + Q * 1000).toGMTString()) : "") + (c ? ";domain=" + c || document.location.domain : "") + (C ? ";secure" : "");
            O[i] = I;
            return true
        }
        return false
    ...
    o.del = function (i, I, Q) {
        if (Cookie.isSet(i)) {
            document.cookie = i + "=" + (I ? "; path=" + I : "") + (Q ? "; domain=" + Q : "") + (secure ? "; secure" : "") + "; NoExp=Thu, 01-Jan-70 00:00:01 GMT";
            delete O[i];
            return true
        }
        return false
    ...
    o.delAll = function () {
        for (var i in O) {
            if (O.hasOwnProperty(i)) o.del(i);
        }
    };
    (function () {
        var I = document.cookie.split(/\s*;\s*/);
        for (i = 0, pL = I.length; i < pL; i++) {
            var Q = I[i].split(/\s*=\s*/);
            O[Q[0]] = unescape(Q[1]);
        }
    })()
...
DocumentSelection = new function () {
    ...
    var _ = function (l, o) {
        ...
        case 'input':
            if (C.type && C.type != 'text' && C.type != 'password') return false;
        case 'textarea':
            v = "input";
            break;
        case 'iframe':
    ...
    var c = function (I, l, o) {
        if (window.getSelection && 'iframe' != I.tagName.toLowerCase()) {
            ...
            else I.scrollTop = l; if (o > C.x) I.scrollLeft = C.x;
...
DocumentSelection.module = {
    'input': function (o) {
        ...
        O.ins = function (i, l) {
            ...
            i.value = C.substring(0, c) + l + C.substring(c, C.length);
            c += l.length;
            O.setRange(i, c, c);
            return c
        };
        ...
        O.getSelectionOffset = function (I) {
            ...
            if ('function' == typeof I.setSelectionRange) {
                ...
                V = V.replace(/\x20\x20/g, "\x20\xa0").replace(/</g, "&lt;").replace(/>/g, "&gt");
        ...
        I.getPos = function (i) {
            ...
            if ('function' == typeof i.getSelection) {
                var o = i.getSelection(),
                    ...
                    v = 0,
                    V = 0,
                    x, X = i.document.createTreeWalker(i.document.body, NodeFilter.SHOW_TEXT, null, false);
        ...
        I.setRange = function (i, l, o) {
            if ('function' == typeof i.getSelection) {
                ...
                var Q = i.document.createRange(),
                    _ = 0,
                    c = 0,
                    C, e, v = i.document.createTreeWalker(i.document.body, NodeFilter.SHOW_TEXT, null, false);
