 ...
 <tr>
 	<td align="left" style="width:25%"> &nbsp; Copyright  &copy; 2013-16 
 ...
 */ 	?>
 ...
 <div class="ActiveVerse" id="verseAlert"  >
    <div id="verseText" class="<?php echo $userSetting->getArabicFont(); ?>" style="font-size:<?php echo $userSetting->getArabicFontSize()?>px;"></div>
  </div>
